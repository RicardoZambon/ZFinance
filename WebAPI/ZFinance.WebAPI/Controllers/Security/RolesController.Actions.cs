...
namespace ZFinance.WebAPI.Controllers.Security
{
    public partial class RolesController
    {
        ...
        /// <summary>
        /// Lists the actions of the role asynchronous.
        /// </summary>
        /// <param name="roleID">The role identifier.</param>
        /// <param name="parameters">The parameters.</param>
        /// <returns>List with the actions of the role accordingly to the parameters.</returns>
        ...
        public async Task<IActionResult> Actions([FromRoute] long roleID, [FromBody] ListParametersModel parameters)
        {
            try
            {
                return Ok(await rolesService.ListRoleActionsAsync(roleID, parameters));
            }
        ...
        public async Task<IActionResult> Actions([FromRoute] long roleID, [FromBody] RelationshipUpdateModel<long> model)
        {
            try
            {
                await rolesService.UpdateRelationshipRoleActionsAsync(roleID, model);
                return Ok();
            }
            catch (MissingUserPermissionException) { return Forbid(); }
            catch (EntityNotFoundException<Roles>) { return NotFound(); }
