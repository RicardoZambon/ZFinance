...
namespace ZFinance.WebAPI.Controllers.Security
{
    public partial class RolesController
    {
        ...
        /// <summary>
        /// Lists the menus of the role asynchronous.
        /// </summary>
        /// <param name="roleID">The role identifier.</param>
        /// <param name="parameters">The parameters.</param>
        /// <returns>List with the menus of the role accordingly to the parameters.</returns>
        ...
        public async Task<IActionResult> Menus([FromRoute] long roleID, [FromBody] ListParametersModel parameters)
        {
            try
            {
                return Ok(await rolesService.ListRoleMenusAsync(roleID, parameters));
            }
        ...
        public async Task<IActionResult> Menus([FromRoute] long roleID, [FromBody] RelationshipUpdateModel<long> model)
        {
            try
            {
                await rolesService.UpdateRelationshipRoleMenusAsync(roleID, model);
                return Ok();
            }
            catch (MissingUserPermissionException) { return Forbid(); }
            catch (EntityNotFoundException<Roles>) { return NotFound(); }
